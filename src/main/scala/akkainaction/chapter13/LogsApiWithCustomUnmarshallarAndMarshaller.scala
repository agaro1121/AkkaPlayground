...
class LogsApiWithCustomUnmarshallarAndMarshaller(implicit val mat: ActorMaterializer, ec: ExecutionContext) extends SprayJsonSupport with DefaultJsonProtocol {
